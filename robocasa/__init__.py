...
from robocasa.environments.kitchen.single_stage.kitchen_move_hot_object import (
    MoveHotObjectToSink,
    MoveObjectOnStoveToSink,  # Backward compatible alias
    MoveFrypanToSink,
    MovePotToSink,
    MoveKettleToSink,
    MoveCoffeeCupToSink,
